...
public class DRCPSample {
  final static String DRCP_URL= "jdbc:oracle:thin:@localhost:1521(CONNECT_DATA=(SERVICE_NAME=myorcldbservicename)(server=POOLED)))";
  final static String DB_USER = "oracle";
  final static String DB_PASSWORD = "system";
